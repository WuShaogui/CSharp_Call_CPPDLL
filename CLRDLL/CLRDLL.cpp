...
public class Program
{
    ...
    [DllImport("mydll.dll", EntryPoint = "ProcessPoints", SetLastError = true, CharSet = CharSet.Ansi)]
    ...
    [DllImport("mydll.dll", EntryPoint = "ProcessPointsv2", SetLastError = true, CharSet = CharSet.Ansi)]
